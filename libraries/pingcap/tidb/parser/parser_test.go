...
func (s *testParserSuite) TestSimple(c *C) {
	...
	// Fix: https://github.com/insionng/zenpress/libraries/pingcap/tidb/issues/971
...
func (s *testParserSuite) TestDMLStmt(c *C) {
	...
	table := []testCase{
		...
		// For https://github.com/insionng/zenpress/libraries/pingcap/tidb/issues/320
		{`(select 1);`, true},

		// For https://github.com/insionng/zenpress/libraries/pingcap/tidb/issues/1050
...
func (s *testParserSuite) TestType(c *C) {
	...
	table := []testCase{
		...
		// For https://github.com/insionng/zenpress/libraries/pingcap/tidb/issues/312
