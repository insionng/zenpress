...
func (s *testSessionSuite) TestSelect(c *C) {
	...
	// Testcase For https://github.com/insionng/zenpress/libraries/pingcap/tidb/issues/1071
...
func (s *testSessionSuite) TestBootstrap(c *C) {
	...
	// For https://github.com/insionng/zenpress/libraries/pingcap/tidb/issues/1096
	store = newStore(c, s.dbName)
	se, err = CreateSession(store)
	c.Assert(err, IsNil)
	doDMLWorks(se)
...
func (s *testSessionSuite) TestOrderBy(c *C) {
	...
	// Fix issue https://github.com/insionng/zenpress/libraries/pingcap/tidb/issues/337
...
func (s *testSessionSuite) TestResultType(c *C) {
	defer testleak.AfterTest(c)()
	// Testcase for https://github.com/insionng/zenpress/libraries/pingcap/tidb/issues/325
	store := newStore(c, s.dbName)
	se := newSession(c, store, s.dbName)
...
func (s *testSessionSuite) TestIssue463(c *C) {
	defer testleak.AfterTest(c)()
	// Testcase for https://github.com/insionng/zenpress/libraries/pingcap/tidb/issues/463
	store := newStore(c, s.dbName)
	se := newSession(c, store, s.dbName)
...
func (s *testSessionSuite) TestBuiltin(c *C) {
	...
	// Testcase for https://github.com/insionng/zenpress/libraries/pingcap/tidb/issues/382
...
// For https://github.com/insionng/zenpress/libraries/pingcap/tidb/issues/571
